...
5. The current synthetic grid is only a display subdivision of five district rows. Repeating district profiles over cells is not population disaggregation; do not multiply district metrics by the number of cells.

...
| Legal geography | Astana city GIS / geocadastre; Adilet legal acts; National Spatial Data Infrastructure catalogue | The model's five district profiles are synthetic; Astana's current administrative districts and the baseline geography do not have an approved crosswalk. Public GIS viewer/service does not grant data reuse rights | **Not needed for one school-site pilot:** use verified site/road geometries and avoid five-district joins. Required before district score mapping |
